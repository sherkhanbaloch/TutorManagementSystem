...
namespace TutorManagementSystem
{
    public partial class Student_Signup : System.Web.UI.Page
    {
        ...
        public void ResetContact()
        {
            ...
            addressTxt.Text = "";
            classTxt.Text = "";
            goingToDDL.ClearSelection();
            subjectTxt.Text = "";
            contactTxt.Text = "";
            tuitiontypeDDL.ClearSelection();
            tutorperferDDL.ClearSelection();
            usernameTxt.Text = "";
            passwordTxt.Text = "";
        ...
        protected void btnStudentSignup_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string qry = "insert into tbl_Students values (@name, @fname, @surname, @gender, @age, @country, @city, @address, @class, @goingto, @subject, @contact, @tuitiontype, @tutorperfer, @username, @password)";
                ...
                cmd.Parameters.AddWithValue("@goingto", goingToDDL.SelectedItem.ToString());
                cmd.Parameters.AddWithValue("@subject", subjectTxt.Text);
                cmd.Parameters.AddWithValue("@contact", contactTxt.Text);
                cmd.Parameters.AddWithValue("@tuitiontype", tuitiontypeDDL.SelectedItem.ToString());
                cmd.Parameters.AddWithValue("@tutorperfer", tutorperferDDL.SelectedItem.ToString());
                ...
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "Swal.fire('Sign Up Failed','Record Has Not Been Inserted.','error')", true);
                }
            }
